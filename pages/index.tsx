...
const myNftDropContractAddress = "0x1C8797593b80B88ad398B69E8b7E29cC6b86902F";
      ...
      <div className={styles.mintInfoContainer}>
        {isLoading ? (
          ...
          <>
            ...
            <h1>Walter NFT (Wanderer)</h1>
            {/* Description of your NFT Collection */}
            <p className={styles.description}>
            Walter NFT consists of <b>10,000 NFTs</b>, each of which is a collectible <br></br>with a solid <b>use case</b> within the ecosystem.<br/><br/>
            </p>
          </div>
            ...
            <div className={styles.imageSide}>
              ...
              claimConditions.data?.every(
                ...
                <div>
                  <h2>
                    This Collection is not ready to be minted yet.
                  </h2>
                </div>
              ) : !activeClaimCondition.data && claimConditions.data ? (
                <div>
                  <h2>Minting starts in:</h2>
